...
hl.bind(mainMod .. " + E",          hl.dsp.exec_cmd("hyprctl clients -j | grep -q 'com.netxph.yazi_scratchpad' || (uwsm app -- ghostty --class=com.netxph.yazi_scratchpad -e yazi &)"))
hl.bind(mainMod .. " + T",          hl.dsp.workspace.toggle_special("terminal"))
hl.bind(mainMod .. " + T",          hl.dsp.exec_cmd("hyprctl clients -j | grep -q 'com.netxph.terminal_scratchpad' || (uwsm app -- ghostty --class=com.netxph.terminal_scratchpad &)"))
...
hl.bind(mainMod .. " + SUPER_L",    hl.dsp.exec_cmd(noctCall .. "panel-toggle launcher"), { release = true })
