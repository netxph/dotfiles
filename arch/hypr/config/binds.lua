...
hl.bind(mainMod .. " + N",          hl.dsp.exec_cmd("pgrep -f 'ghostty --class=com[.]netxph.nvim_scratchpad' >/dev/null || uwsm app -- ghostty --class=com.netxph.nvim_scratchpad -e nvim $HOME/.scratchpad.md"))
